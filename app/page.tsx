...
import { about, boardIntro, heroFacts, literacies, stats } from "@/lib/content";
    ...
    <section className="relative overflow-hidden pt-10 pb-20 sm:pt-16 sm:pb-28">
      ...
      <Container className="relative">
        <div className="grid items-center gap-14 lg:grid-cols-[1.05fr_0.95fr] lg:gap-16">
          <div>
            <Reveal>
              <Eyebrow>Nigeria&apos;s first · school-embedded · multi-literacy club</Eyebrow>
            </Reveal>
            ...
            <Reveal delay={160}>
              <p className="text-pretty mt-7 max-w-xl text-base leading-relaxed text-navy-800/75 sm:text-lg">
                ...
                children build practical life skills early — financial literacy,
                digital literacy, entrepreneurship, leadership, communication,
                and hands-on creative skills.
              </p>
            </Reveal>
          ...
          <Reveal delay={180} className="relative">
            <div className="relative mx-auto max-w-md lg:max-w-none">
              {/* Extra bottom padding leaves room for the floating stat card
                  to overlap without covering the last pillar. */}
                ...
                <div className="relative">
                  ...
                  <ul className="mt-7 space-y-3">
                    {literacies.map((pillar) => (
                      <li
                        key={pillar.slug}
                        className="flex items-center gap-3.5 rounded-2xl border border-white/10 bg-white/[0.05] px-4 py-3 transition duration-300 hover:border-gold-400/40 hover:bg-white/10"
                      >
              ...
              {/* Floating proof card */}
              <div className="absolute right-4 -bottom-7 w-56 rounded-2xl border border-navy-900/8 bg-white p-5 shadow-[0_24px_50px_-24px_rgba(10,32,56,0.45)] sm:-right-6">
                <p className="font-display text-3xl leading-none font-semibold text-navy-900">
                  300+
                </p>
                <p className="mt-2 text-xs leading-snug text-navy-800/65">
      ...
      <Container>
        <div className="grid gap-12 lg:grid-cols-[0.95fr_1.05fr] lg:gap-16">
          <Reveal>
            ...
            <ButtonLink href="/about" variant="ghost" className="group mt-8">
              More about the club
              <ArrowRight />
            </ButtonLink>
          </Reveal>
            ...
            <div className="rounded-[2rem] border border-navy-900/8 bg-white p-7 shadow-[0_1px_2px_rgba(10,32,56,0.04),0_28px_60px_-40px_rgba(10,32,56,0.45)] sm:p-9">
              ...
              <ul className="mt-7 flex flex-wrap gap-2">
                {about.channels.map((channel) => (
                  <li
                    key={channel}
                    className="rounded-full bg-sand px-3.5 py-1.5 text-xs font-medium text-navy-800/80"
                  >
                    {channel}
                  </li>
                ))}
